...
import groupapp from '../images/groupapp.png';
...
<section class="list1"><br/>
  <div class="menu-row">
    <div class="menu-column">
      <h3>COLLECTIONS</h3>
      <a href="#">Titan Automat</a>
      <a href="#">Pollice Batman</a>
      <a href="#">Steller</a>
      <a href="#">Raga Power</a>
    ...
    <div class="menu-column">
      ...
      <a href="#">Enciricle Program</a>
      <a href="#">Find Titan World Stores</a>
    </div>


    <div class="menu-column">
      <h3>CONTACT US</h3>
      <a href="#">1800-366-6543</a>
      <a href="#">customercare@titan.com Acid</a>
      <a href="#">Help & Contant</a>
      <a href="#">FAQs</a>
    </div>
    ...
    <div className='col6'>
      <img className='back1' src={groupapp} alt='...'/>
    </div>

    <div className='col7'>
      <img className='back2' src={play} alt='...'/>
    </div>
  </div><br/>

  <h3>Follow Us With</h3>
  <p className='desgin'><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
  ...
  <h3>Want Help? Click Here To Chat With Us On</h3>
